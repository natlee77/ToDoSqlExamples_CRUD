...
using ToDo_Cosmos_EntityFraimework.Services;

namespace ToDo_Cosmos_EntityFraimework
{
    class Program
    {
        ...
        private static async Task GetToDosByCompletedAsync(bool completed) //lista upp
        {
            //1. hämtning
